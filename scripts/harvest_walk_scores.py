# File: scripts/harvest_walk_scores.py
...
def main():
    ...
    if not os.path.exists(CITY_DATA_PATH):
        print(f"❌ Critical Error: Master city data file missing at {CITY_DATA_PATH}")
        sys.exit(1)
    ...
    scores_database = {}
    print("🚀 Initializing Multi-Score Location Harvester Pipeline...")
    ...
    print(f"🏁 Complete. Lifestyle database built at: {OUTPUT_PATH}")
